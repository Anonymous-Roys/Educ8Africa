...
const JobCard = ({ 
  id,
  title, 
  jobTitle, // Legacy support
  description, 
  roleOverview, // New data structure
  departmentId,
  department, // Legacy support
  locationId,
  ...
  const displayTitle = title || jobTitle;
  const displayDescription = description || roleOverview;
